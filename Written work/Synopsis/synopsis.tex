...
The project is based upon the article \citetitle{main_ar} by \citeauthor{main_ar} where the pre-trained CNN has been implemented. The scope of the project is to expand the pre-trained CNN with a RNN on top. 
