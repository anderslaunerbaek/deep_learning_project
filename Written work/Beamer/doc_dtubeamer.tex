...
\frametitle{Networks}
\begin{itemize}
\item Article by Albert Vilamala, Kristoffer H. Madsen and Lars K. Hansen (2017) \cite{main_ar}
\item CNN: VGGNet 16
...
\frame{
	...
	\begin{itemize}
		\item<1-1> Successfully reproduced \cite{main_ar} in TF which was one of the objectives, despite using few different approaches.
		\item<1-1> Added a LSTM cell to the of the VGGNet. The of the RNN does outperform the baseline network on the average performance metrics, despite the RNN does achieve a better sensitivity in the W sleep stage and in the R sleep stage.
